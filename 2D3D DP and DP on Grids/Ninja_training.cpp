...
/* Q7) A Ninja has an ‘N’ Day training schedule. He has to perform one of these three activities (Running, Fighting Practice, or Learning New Moves) each day.
...
We are given a 2D Array POINTS of size ‘N*3’ which tells us the merit point of a specific activity on that particular day.
